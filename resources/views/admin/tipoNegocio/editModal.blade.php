...
<div class="modal fade" id="editTipoNegocioModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Form::model($tipoNegocios,['route'=>['tiponegocio.update','test'], 'method'=>'PATCH','files' => 'true'])!!}
          
           
                <div class="modal-body">
                        <input type="hidden" name="id_tiponegocio" id="id_tiponegocio" value="">
                        <div class="card">
