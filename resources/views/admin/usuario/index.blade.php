@extends("theme.crui.layout")
    ...
    @include('superAdmin/usuario/delete')
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-striped table-bordered datatable dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="border-collapse: collapse !important">
                            <thead>
                                <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Nombre: activate to sort column ascending" style="width: 170px;">C.I/Ruc</th>
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Date registered: activate to sort column ascending" style="width: 201px;">Nombre</th>
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Date registered: activate to sort column ascending" style="width: 201px;">Apellido</th>
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Date registered: activate to sort column ascending" style="width: 201px;">Teléfono</th>
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Date registered: activate to sort column ascending" style="width: 201px;">Celular</th>z
                                    
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Date registered: activate to sort column ascending" style="width: 201px;">Email</th>
                            ...
                            <tbody>
                                @if(isset($usuarios))
                                @foreach ($usuarios as $tn)
                                <tr role="row" class="odd">
                                    <td class="sorting_1">{{$tn->cedula}}</td>
                                    <td class="sorting_1">{{$tn->nombre}}<br>{{$tn->apellido}}</td>
                                    <td class="sorting_1">{{$tn->direccion}}</td>
                                    <td class="sorting_1">{{$tn->celular}}</td>
                                    <td class="sorting_1">{{$tn->correo}}</td>
                                    
                                    <td>    
                                        <a href="" class="btn btn-warning btn-xs " data-backdrop="static" data-keyboard="false"
                                        data-id_usuario="{{$tn->id_usuario}}" data-nombre="{{$tn->nombre}}" data-apellido="{{$tn->apellido}}" data-direccion="{{$tn->direccion}}"
                                        data-id_celular="{{$tn->id_celular}}" data-telefono="{{$tn->telefono}}" data-correo="{{$tn->correo}}"
                                        data-id_cedula="{{$tn->id_cedula}}"
                                        ...
                                        data-action="{{route('usuario.destroy',$tn->id_usuario)}}"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="dataTables_length" id="DataTables_Table_0_length">
                             <label>Show</label>   <label>
                                    ...
                                    <option value="usuario?pag=4"<?php 
                                    if ($pag=='4') {
                                        echo 'selected';
                                    }?>>4</option>
                                    <option value="usuario?pag=10"<?php 
                                    if ($pag=='10') {
                                        echo 'selected';
                                    }?>>10</option>
                                    <option value="usuario?pag=25"<?php 
                                    if ($pag=='25') {
                                        echo 'selected';
                                    }?>>25</option>
                                    <option value="usuario?pag=50"<?php 
                                    if ($pag=='50') {
                                        echo 'selected';
                                    }?>>50</option>
