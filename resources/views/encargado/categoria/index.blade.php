                                ...
                                <tr role="row" class="odd">
                                 ...
                                 height: 30px;" src='svg/education/{{$cat->icono}}.svg'>
                                    ...
                                    <td>    
                                        ...
                                        data-id_categoria="{{$cat->id_categoria}}" data-nombre="{{$cat->nombre}}" data-icono="{{$cat->icono}}" data-toggle="modal" data-target="#myEditModal"  >
                                        <i class="fa fa-pencil-square-o"  aria-hidden="true"></i>  
                                        </a>

                                        <a title="Eliminar" data-toggle="modal" data-target="#modalDelete" 
                                        data-action="{{route('categoria.destroy',$cat->id_categoria)}}"
                                                    data-nombre="{{$cat->nombre}}" href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash" aria-hidden="true"></i>
                                        </a>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="dataTables_length" id="DataTables_Table_0_length">
                             <label>Show</label>   <label>
                                    ...
                                    <option value="categoria?pag=4"<?php 
                                    if ($pag=='4') {
                                        echo 'selected';
                                    }?>>4</option>
                                    <option value="categoria?pag=10"<?php 
                                    if ($pag=='10') {
                                        echo 'selected';
                                    }?>>10</option>
                                    <option value="categoria?pag=25"<?php 
                                    if ($pag=='25') {
                                        echo 'selected';
                                    }?>>25</option>
                                    <option value="categoria?pag=50"<?php 
                                    if ($pag=='50') {
                                        echo 'selected';
                                    }?>>50</option>
